<?php
    class widget_most_viewed extends WP_Widget {
        ...
        function widget_most_viewed() {
            $widget_ops = array( 'classname' => 'widget_most_viewed' , 'description' => __( " Get posts that have the most views." , 'shootback' ) );
            parent::__construct( 'widget_touchsize_most_viewed' , __( "Most viewed posts" , 'shootback' ) , $widget_ops );
        }
		...
		<?php
            ...
            if( is_array($recent->posts) && !empty($recent->posts) ){
                ...
                <ul class="widget-items row <?php echo ' widget-columns-' . $columns; if( $image == 'y' ) echo ' widget-has-image'; ?>"><?php $i = 1;
