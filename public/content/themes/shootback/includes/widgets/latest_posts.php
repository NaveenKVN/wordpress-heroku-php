...
class widget_latest_posts extends WP_Widget {
	...
	/*Constructor*/
		$widget_ops = array('classname' => 'widget_latest_posts ', 'description' => __( 'Latest Posts' , 'shootback' ) );
		parent::__construct('widget_touchsize_latestPosts', __( 'Latest Posts' , 'shootback' ), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		$title = empty($instance['title']) ? __('Latest Posts','shootback') : apply_filters('widget_title', $instance['title']);
...
?>
		...
		<p>
		    <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of posts','shootback') ?>:
