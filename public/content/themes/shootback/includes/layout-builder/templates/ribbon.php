...
<div class="col-md-12 col-lg-12">
	<div class="ts-ribbon-banner">
		<div class="ribbon-image"><?php echo ts_var_sanitize($image); ?></div>
		<div style="<?php echo ts_var_sanitize($background); ?>" class="ts-ribbon <?php echo ts_var_sanitize($align); ?>">
			<div class="rb-content" style="<?php echo ts_var_sanitize($text_color, 'esc_attr'); ?>">
				<div class="rb-separator">
					<span style="<?php echo ts_var_sanitize($text_color, 'esc_attr'); ?>"><?php echo ts_var_sanitize($title, 'esc_attr'); ?></span>
				</div>
				<div class="rb-description">
					<?php echo ts_var_sanitize($text); ?>
				</div>
