...
<div class="col-lg-12">
	<form method="post" class="contact-form">
		<div class="row">
			...
			<div class="col-lg-12">
				<input type="button" value="<?php _e( 'Send', 'shootback' ); ?>" class="contact-form-submit">
			</div>
		</div>
