<?php
	$message =  __( 'This template does not exists', 'shootback' );
	if (!isset($_GET['id'])) {
	 	die("<p>" . $message . "</p>");
	...
	<ul class="layout_builder_row">
			<li class="row-editor">
				<ul class="row-editor-options">
					<li><a href="#" class="add-column"><?php _e( '+', 'shootback' ); ?></a></li>
					<li><a href="#" class="remove-row"><?php _e( 'delete', 'shootback' ); ?></a></li>
					<li><a href="#" class="move"><?php _e( 'move', 'shootback' ); ?></a></li>
				</ul>
			</li>
			...
			<li class="empty-row">
				<?php _e( 'The row is empty. Click here to add new column', 'shootback' ); ?>
			</li>
	</ul>
</script>
...
<li data-columns="1" data-type="empty" class="columns1"> 
	<p><?php _e( 'Empty column', 'shootback' ); ?></p>
...
<div class="builder-section-container">
	<h2 class="builder-section-title"><?php _e( 'Header', 'shootback' ); ?></h2>
	...
	<a href="#" data-location="header" class="app red-ui-button add-top-row"><?php _e( 'Add row to the top', 'shootback' ); ?></a><br/><br/>
	<div class="layout_builder" id="section-header">
		<?php echo $data['header']; ?>
	</div>
	<div style="clear: both"></div>
	<br>
	<a href="#" data-location="header" class="app red-ui-button add-bottom-row"><?php _e( 'Add row to the bottom', 'shootback' ); ?></a>
	<div style="clear: both"></div>
</div>
<div class="builder-section-container">
	<h2 class="builder-section-title"><?php _e( 'Content', 'shootback' ); ?></h2>
	...
	<div style="clear: both"></div>
	<a href="#" data-location="content" class="app red-ui-button add-top-row"><?php _e( 'Add row to the top', 'shootback' ); ?></a><br/><br/>
	<div class="layout_builder" id="section-content">
		<?php echo $data['content']; ?>
	</div>
	<div style="clear: both"></div>
	<br>
	<a href="#" data-location="content" class="app red-ui-button add-bottom-row"><?php _e( 'Add row to the bottom', 'shootback' ); ?></a>
	<div style="clear: both"></div>
</div>
<div class="builder-section-container">
	<h2 class="builder-section-title"><?php _e( 'Footer', 'shootback' ); ?></h2>
	...
	<div style="clear: both"></div>
	<a href="#" data-location="footer" class="app red-ui-button add-top-row"><?php _e( 'Add row to the top', 'shootback' ); ?></a><br/><br/>
	<div class="layout_builder" id="section-footer">
		<?php echo $data['footer']; ?>
	</div>
	<div style="clear: both"></div>
	<br>
	<a href="#" data-location="footer" class="app red-ui-button add-bottom-row"><?php _e( 'Add row to the bottom', 'shootback' ); ?></a>
	<div style="clear: both"></div>
</div>
