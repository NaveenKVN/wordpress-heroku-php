...
<div class="builder-section-container">
	...
	?>	
		<table cellspacing="0" class="red-ui-table-list">
			<thead>
				<th width="300"><?php _e( 'Template name', 'shootback' ); ?></th>
				<th><?php _e( 'Options', 'shootback' ); ?></th>
			</thead>
			<tbody>
	...
	<?php else: ?>
		<p><?php _e( 'You don\'t have templates, but you can create them by pressing "Create a new Template" button', 'shootback' ); ?></p>
	<?php endif ?>
</div>
