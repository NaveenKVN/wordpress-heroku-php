...
class Element
{
	...
	public static function html ( $element )
	{
		...
		return '<li ' . $attributes . '>
					...
					<span class="element-name">' . self::descriptions($element['type'], $admin_label). $option .'</span>
				 	<span class="edit icon-edit" data-tooltip="Edit this element">'. __('Edit', 'shootback') .'</span>
	...
	public static function descriptions($element = '', $admin_label = '')
	{
		...
		switch ($element) {
			case 'logo':
				return __('Logo', 'shootback');
				break;

			case 'social-buttons':
				return __('Social buttons', 'shootback');
				break;

			case 'searchbox':
				return __('Search', 'shootback');
				break;

			case 'menu':
				return __('Menu', 'shootback');
				break;

			case 'sidebar':
				return __('Sidebar', 'shootback');
				break;

			case 'slider':
				return __('Slider', 'shootback');
				break;

			case 'list-portfolios':
				return __('List Portfolios', 'shootback');
				break;

			case 'listed-features':
				return __('Listed Features', 'shootback');
				break;

			case 'features-block':
				return __('Icon box', 'shootback');
				break;

			case 'facebook-block':
				return __('Facebook Like Box', 'shootback');
				break;

			case 'testimonials':
				return __('Testimonials', 'shootback');
				break;

			case 'last-posts':
				return __('List posts', 'shootback');
				break;

			case 'list-galleries':
				return __('List Galleries', 'shootback');
				break;

			case 'latest-custom-posts':
				return __('Latest custom posts', 'shootback');
				break;
			...
			case 'callaction':
				return __('Call to action', 'shootback');
				break;

			case 'image-coverflow':
				return __('Image carousel', 'shootback');
				break;

			case 'list-products':
				return __('List products', 'shootback');
				break;

			case 'teams':
				return __('Teams', 'shootback');
				break;

			case 'pricing-tables':
				return __('Pricing tables', 'shootback');
				break;

			case 'advertising':
				return __('Advertising', 'shootback');
				break;

			case 'empty':
				return __('Empty', 'shootback');
				break;

			case 'delimiter':
				return __('Delimiter', 'shootback');
				break;

			case 'title':
				return __('Title', 'shootback');
				break;

			case 'image':
				return __('Image', 'shootback');
				break;

			case 'video':
				return __('Video', 'shootback');
				break;
			
			case 'filters':
				return __('Filters', 'shootback');
				break;

			case 'page':
				return __('Page', 'shootback');
				break;

			case 'spacer':
				return __('Spacer', 'shootback');
				break;

			case 'counters':
				return __('Counters', 'shootback');
				break;

			case 'clients':
				return __('Clients block', 'shootback');
				break;	

			case 'contact-form':
				return __('Contact form', 'shootback');
				break;

			case 'buttons':
				return __('Button', 'shootback');
				break;
			case 'icon':
				return __('Icon', 'shootback');
				break;

			case 'post':
				return __('Post', 'shootback');
				break;
			...
			case 'featured-area':
				return __('Featured area', 'shootback');
				break;

			case 'shortcodes':
				return __('Shortcodes', 'shootback');
				break;

			case 'text':
				return __('Text', 'shootback');
				break;

			case 'map':
				return __('Map', 'shootback');
				break;

			case 'banner':
				return __('Banner', 'shootback');
				break;

			case 'toggle':
				return __('Toggle', 'shootback');
				break;
			...
			case 'tab':
				return __('Tabs', 'shootback');
				break;

			case 'list-videos':
				return __('List Videos', 'shootback');
				break;		

			case 'cart':
				return __('Shopping cart', 'shootback');
				break;

			case 'breadcrumbs':
				return __('Breadcrumbs', 'shootback');
				break;

			case 'ribbon':
				return __('Ribbon banner', 'shootback');
				break;

			case 'timeline':
				return __('Timeline features', 'shootback');
				break;

			case 'video-carousel':
				return __('Video carousel', 'shootback');
				break;

			case 'count-down':
				return __('Counter down', 'shootback');
				break;

			case 'powerlink':
				return __('Powerlink', 'shootback');
				break;

			case 'calendar':
				return __('Calendar', 'shootback');
				break;

			case 'events':
				return __('Events', 'shootback');
				break;

			case 'alert':
				return __('Alert', 'shootback');
				break;

			case 'skills':
				return __('Horizontal skills', 'shootback');
				break;

			case 'accordion':
				return __('Article accordion', 'shootback');
				break;

			case 'chart':
				return __('Chart', 'shootback');
				break;

			case 'gallery':
				return __('Gallery', 'shootback');
				break;
	...
	public static function parse_filters( $element )
	{
		...
		$post_types = array('posts', 'portfolio', 'ts-gallery', 'video');
