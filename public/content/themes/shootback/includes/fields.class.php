...
class Fields
{
	...
	public static function logicMetaRadio($parentName, $name, $defaultValue = 'no', $title, $description = ''){
		...
		<div class="meta-box-option meta_title_<?php echo $name;?>">
			...
			<div class="meta-box-option-input">
				...
				<input type="radio" name="<?php echo $parentName; ?>[<?php echo $name; ?>]" value="yes" <?php checked( $element_value, 'yes', true ); ?> id="<?php echo $parentName.'-'.$name.'-yes'; ?>" /> <label class="ts-logic-label" for="<?php echo $parentName.'-'.$name.'-yes'; ?>"><?php _e('Yes', 'shootback'); ?></label>
				<input type="radio" name="<?php echo $parentName; ?>[<?php echo $name; ?>]" value="no" <?php checked( $element_value, 'no', true ); ?> id="<?php echo $parentName.'-'.$name.'-no'; ?>" /> <label class="ts-logic-label" for="<?php echo $parentName.'-'.$name.'-no'; ?>"><?php _e('No', 'shootback'); ?></label>
			</div>
	...
	public static function uploaderMeta($parentName, $name, $defaultValue = '', $title, $description = ''){
		...
		<div class="meta-box-option meta_title_<?php echo $name;?>">
			...
			<div class="meta-box-option-input">
				...
				<input type="button" data-element-id="<?php echo $parentName; ?>-<?php echo $name; ?>" name="<?php echo $parentName; ?>[<?php echo $name; ?>]-submit" id="<?php echo $parentName; ?>[<?php echo $name; ?>]-upload" class="button-primary uploader-meta-field <?php echo $parentName; ?>[<?php echo $name; ?>]-uploade-button" value="<?php _e( 'Upload', 'shootback' ); ?>" />
			</div>
			<div class="meta-box-option-desc">
				<?php echo $description; ?>
			</div>
	...
	public static function inputText($parentName, $name, $defaultValue = '', $title, $description = ''){
		...
		<div class="meta-box-option meta_title_<?php echo $name;?>">
			...
			<div class="meta-box-option-input">
				<label for="<?php echo $parentName; ?>['<?php echo $name; ?>']"></label>
				<input type="text" name="<?php echo $parentName; ?>[<?php echo $name; ?>]" id="<?php echo $parentName; ?>-<?php echo $name; ?>-input-field" class="<?php echo $parentName; ?>[<?php echo $name; ?>]" value="<?php echo @$element_value; ?>"/>
			</div>
			<div class="meta-box-option-desc">
				<?php echo $description; ?>
			</div>
	...
	public static function textareaText($parentName, $name, $defaultValue = '', $title, $description = ''){
		...
		<div class="meta-box-option meta_title_<?php echo $name;?>">
			...
			<div class="meta-box-option-input">
				<label for="<?php echo $parentName; ?>['<?php echo $name; ?>']"></label>
				<textarea cols="35" name="<?php echo $parentName; ?>[<?php echo $name; ?>]" id="<?php echo $parentName; ?>-<?php echo $name; ?>-input-field" class="<?php echo $parentName; ?>[<?php echo $name; ?>]"><?php echo @$element_value; ?></textarea>
			</div>
			<div class="meta-box-option-desc">
				<?php echo $description; ?>
			</div>
