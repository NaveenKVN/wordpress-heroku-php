...
add_action('woocommerce_before_main_content', 'shootback_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'shootback_wrapper_end', 10);

function shootback_wrapper_start() {
?>
	<section id="main">
...
function shootback_wrapper_end() {
?>
...
function custom_woocommerce_product_add_to_cart_text() {
	...
	switch ( $product_type ) {
		case 'external':
			return __( 'Buy product', 'shootback' );
		break;
		case 'grouped':
			return __( 'View', 'shootback' );
		break;
		case 'simple':
			return __( 'Buy now', 'shootback' );
		break;
		case 'variable':
			return __( 'Choose', 'shootback' );
		break;
		default:
			return __( 'More', 'shootback' );
	}
