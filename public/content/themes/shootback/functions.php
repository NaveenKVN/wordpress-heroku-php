...
/**
 * Include to search tags and custom posts
 */
 ...
 * Import demo data
 */
require( get_template_directory() . '/import/ts-importer.php' );
 ...
 * Include the Most liked Functions File
 */
require( get_template_directory() . '/includes/widgets/list-events.php' );
